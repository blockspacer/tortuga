...
class DocumentTransform_FieldTransform : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.firestore.v1beta1.DocumentTransform.FieldTransform) */ {
 public:
  ...
  const ::google::firestore::v1beta1::ArrayValue& append_missing_elements() const;
  ::google::firestore::v1beta1::ArrayValue* release_append_missing_elements();
  ::google::firestore::v1beta1::ArrayValue* mutable_append_missing_elements();
  void set_allocated_append_missing_elements(::google::firestore::v1beta1::ArrayValue* append_missing_elements);
  ...
  const ::google::firestore::v1beta1::ArrayValue& remove_all_from_array() const;
  ::google::firestore::v1beta1::ArrayValue* release_remove_all_from_array();
  ::google::firestore::v1beta1::ArrayValue* mutable_remove_all_from_array();
  void set_allocated_remove_all_from_array(::google::firestore::v1beta1::ArrayValue* remove_all_from_array);
...
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::release_append_missing_elements() {
  // @@protoc_insertion_point(field_release:google.firestore.v1beta1.DocumentTransform.FieldTransform.append_missing_elements)
  if (has_append_missing_elements()) {
    clear_has_transform_type();
      ::google::firestore::v1beta1::ArrayValue* temp = transform_type_.append_missing_elements_;
...
inline const ::google::firestore::v1beta1::ArrayValue& DocumentTransform_FieldTransform::append_missing_elements() const {
  // @@protoc_insertion_point(field_get:google.firestore.v1beta1.DocumentTransform.FieldTransform.append_missing_elements)
...
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::mutable_append_missing_elements() {
  if (!has_append_missing_elements()) {
    clear_transform_type();
    set_has_append_missing_elements();
    transform_type_.append_missing_elements_ = new ::google::firestore::v1beta1::ArrayValue;
  }
  // @@protoc_insertion_point(field_mutable:google.firestore.v1beta1.DocumentTransform.FieldTransform.append_missing_elements)
...
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::release_remove_all_from_array() {
  // @@protoc_insertion_point(field_release:google.firestore.v1beta1.DocumentTransform.FieldTransform.remove_all_from_array)
  if (has_remove_all_from_array()) {
    clear_has_transform_type();
      ::google::firestore::v1beta1::ArrayValue* temp = transform_type_.remove_all_from_array_;
...
inline const ::google::firestore::v1beta1::ArrayValue& DocumentTransform_FieldTransform::remove_all_from_array() const {
  // @@protoc_insertion_point(field_get:google.firestore.v1beta1.DocumentTransform.FieldTransform.remove_all_from_array)
  return has_remove_all_from_array()
      ? *transform_type_.remove_all_from_array_
      : *reinterpret_cast< ::google::firestore::v1beta1::ArrayValue*>(&::google::firestore::v1beta1::_ArrayValue_default_instance_);
}
inline ::google::firestore::v1beta1::ArrayValue* DocumentTransform_FieldTransform::mutable_remove_all_from_array() {
  if (!has_remove_all_from_array()) {
    clear_transform_type();
    set_has_remove_all_from_array();
    transform_type_.remove_all_from_array_ = new ::google::firestore::v1beta1::ArrayValue;
  }
  // @@protoc_insertion_point(field_mutable:google.firestore.v1beta1.DocumentTransform.FieldTransform.remove_all_from_array)
